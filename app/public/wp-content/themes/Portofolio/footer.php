<?php wp_footer(); ?>
    ...
    <section id="footer" class="relative bg-white">
      <!-- LINE OVER THE FOOTER -->
        ...
        <div class="py-auto bg-gray-800">
          <p class="text-center font-raleway text-3xl text-gray-400 hover:text-royalblue-400 pt-6">Get in Touch</p>
          <div class="icons flex justify-center pt-5 pb-3">
